<html>
	<head>
		<link type="text/css" rel="stylesheet" href="CSS/IndividualApptForms.css" />
		<title>Individual Appointments Input</title>
	</head>
	...
	<body>
		<div id="wrapper">
			<div id="body">
				...
				<form action="ScheduleIndvAppts.php" method="post" name="form1" >
